...
# -------------------------------------------------------------------------
# Function to perform the unpredictable conditional Poisson MaxSPRT regression surveillance - Version edited at August-04-2025
# -------------------------------------------------------------------------

AnalyzeSetUpRegression.CondPoisson<- function(name,N="n",cc="n",alpha=0.05,R0=1,rho=1,mref=999,title="n",address="n")
{
...
if(is.numeric(cc)==FALSE){stop("Symbols and texts are not applicable for 'cc'. It must be an integer greater than zero.",call. =FALSE)}

if(cc<=0){stop("'cc' must be an integer greater than zero.",call. =FALSE)}
...
# line 8: the first entry has the historical number of events, cc.
# line 9: CVl
...
########### CLOSES THE AnalyzeSetUpRegression.CondPoisson
######################################################
