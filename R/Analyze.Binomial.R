...
#AnalyzeSetUp.Binomial(name="test",N=25, alpha=0.05, pp=0.44, M=5, AlphaSpendType="power-type", rho=0.5,address="C:/Users/Visitante/Ivair/POST-DOC/Material para construcao do pacote Sequential/PASTA PARA TREINO")
#system.time(res<- Analyze.Binomial(name="test",test=1,p=0.44,cases=6,controls=2))



# AnalyzeSetUp.Binomial(name="test2",N=25,alpha=0.05,zp=1,pp="n",M=1,AlphaSpendType="Wald",rho="n",title="This is an example of output name",address="C:/Users/Visitante/Ivair/POST-DOC/Material para construcao do pacote Sequential/PASTA PARA TREINO")

#zt<- 1
#casest<- 5
#controlst<- 0

#system.time(res<- Analyze.Binomial(name="test2",test=1,z=zt,p="n",cases=casest,controls=controlst))
