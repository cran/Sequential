...
# -------------------------------------------------------------------------
# Function to perform the unpredictable binomial MaxSPRT regression surveillance - Version edited at July-06-2025
# -------------------------------------------------------------------------

AnalyzeSetUpRegression.Binomial<- function(name,N="n",alpha=0.05,R0=1,rho=1,mref=999,title="n",address="n")
{
...
########### CLOSES THE AnalyzeSetUpRegression.Binomial
######################################################
